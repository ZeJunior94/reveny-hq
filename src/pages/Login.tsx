    ...
    <div className="w-full min-h-screen bg-[#0d0d0d] flex items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-xl px-5 py-3.5 text-sm transition-colors"
        >
          {/* Google icon */}
        ...
        <p className="text-white/20 text-xs mt-6 text-center">
          Acesso restrito à equipe Reveny
        </p>
      </div>
    </div>
  );
